...
bridge = peripheral.find("rs_bridge") --Bridge
...
resources = {
    {name = "Planks", rn = "minecraft:oak_planks", min = 32, type = "item"},
    {name = "Processor", rn = "refinedstorage:raw_advanced_processor", min = 4, type = "item"},
    {name = "Stick", rn = "minecraft:stick", min = 32, type = "item"}
}
